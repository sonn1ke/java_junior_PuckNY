...
public class TestColoredCircle {
    ...
    @Test
    public void testSetWrongColor() throws ColorException {
        assertThrows(ColorException.class, () -> new ColoredCircle(0, 20, 10, "YELLOW"));
        assertThrows(ColorException.class, () -> new ColoredCircle(0, 20, 10, (String) null));
        assertThrows(ColorException.class, () -> new ColoredCircle(0, 20, 10, (Color) null));
